...
/**
 * Long-press gesture composable extracted from FeishuH5View.vue.
 * Shared by FeishuGalleryPage and FeishuChatPage.
 *
 * Provides touch event handlers for long-press detection on mobile,
 * with auto-cancel on finger-move and residual-selection cleanup.
 */
